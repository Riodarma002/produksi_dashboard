# -*- coding: utf-8 -*-
"""
Analisa File Baru - db hourly report
Download dan cek struktur sheet, kolom, dan format data
"""
import requests
import pandas as pd
import io
...
# Link baru dari user
NEW_ONEDRIVE_LINK = "https://mgeid-my.sharepoint.com/:x:/g/personal/planning_department_mgeid_onmicrosoft_com/IQCcW88khWRCTZFZE9PnZxdkAdVZbA3srdgAZbYUWf4lxNY?e=gABCsf"

print("="*80)
print("DOWNLOAD FILE BARU")
print("="*80)
...
try:
    ...
    for sheet_name in xl_file.sheet_names:
        ...
        print(f"\n[INFO] Dimensions (first 5 rows): {df.shape[0]} rows x {df.shape[1]} columns")
        ...
        for i, col in enumerate(df.columns, 1):
            ...
            print(f"  {i:2}. {col:40} | {dtype:10} | Sample: {sample_str}")

        # Cek data types
        print(f"\n[INFO] First row preview:")
        print(df.to_string(max_cols=10, max_rows=3))
